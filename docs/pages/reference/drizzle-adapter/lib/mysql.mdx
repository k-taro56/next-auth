...
| Parameter | Type |
| :------ | :------ |
| `schema` | [`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`DefaultMySqlSchema`](mysql.mdx#defaultmysqlschema)\> |

### Returns

[`Required`](https://www.typescriptlang.org/docs/handbook/utility-types.html#requiredtype)\<[`DefaultMySqlSchema`](mysql.mdx#defaultmysqlschema)\>
