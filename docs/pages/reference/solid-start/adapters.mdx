...
`Promise`\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterSession`](adapters.mdx#adaptersession)\>
...
`Promise`\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterUser`](adapters.mdx#adapteruser)\>
...
`Promise`\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterAccount`](adapters.mdx#adapteraccount)\>
...
`Promise`\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| [`AdapterAccount`](adapters.mdx#adapteraccount)\>
