...
##### threads\_profile\_picture\_url?
...
| Parameter | Type |
| :------ | :------ |
| `config` | [`OAuthUserConfig`](../providers.mdx#oauthuserconfigprofile)\<[`ThreadsProfile`](threads.mdx#threadsprofile)\> |

### Returns

[`OAuthConfig`](../providers.mdx#oauthconfigprofile)\<[`ThreadsProfile`](threads.mdx#threadsprofile)\>
