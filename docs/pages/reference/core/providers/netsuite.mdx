...
| Type parameter |
| :------ |
| `P` extends [`NetSuiteProfile`](netsuite.mdx#netsuiteprofile) |

### Parameters

| Parameter | Type |
| :------ | :------ |
| `config` | [`OAuthUserConfig`](../providers.mdx#oauthuserconfigprofile)\<`P`\> & [`OAuthNetSuiteOptions`](netsuite.mdx#oauthnetsuiteoptions) |
