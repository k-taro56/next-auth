...
| Parameter | Type |
| :------ | :------ |
| `config` | [`OIDCUserConfig`](../providers.mdx#oidcuserconfigprofile)\<[`Auth0Profile`](auth0.mdx#auth0profile)\> |

### Returns

[`OIDCConfig`](../providers.mdx#oidcconfigprofile)\<[`Auth0Profile`](auth0.mdx#auth0profile)\>
