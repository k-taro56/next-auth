...
| Parameter | Type |
| :------ | :------ |
| `options` | [`OAuthUserConfig`](../providers.mdx#oauthuserconfigprofile)\<`Record`\<`string`, `any`\>\> & \{ `apiVersion`: `string`; } |

### Returns

[`OAuthConfig`](../providers.mdx#oauthconfigprofile)\<`Record`\<`string`, `any`\>\>
