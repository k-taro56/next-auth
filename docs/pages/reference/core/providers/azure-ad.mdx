...
| Type parameter |
| :------ |
| `P` extends [`AzureADProfile`](azure-ad.mdx#azureadprofile) |

### Parameters

| Parameter | Type |
| :------ | :------ |
| `options` | [`OAuthUserConfig`](../providers.mdx#oauthuserconfigprofile)\<`P`\> & \{ `profilePhotoSize`: \| `64` \| `48` \| `96` \| `120` \| `240` \| `360` \| `432` \| `504` \| `648`; `tenantId`: `string`; } |
