...
| Type parameter |
| :------ |
| `P` extends [`AppleProfile`](apple.mdx#appleprofile) |

### Parameters

| Parameter | Type |
| :------ | :------ |
| `options` | [`Omit`](https://www.typescriptlang.org/docs/handbook/utility-types.html#omittype-keys)\<[`OAuthUserConfig`](../providers.mdx#oauthuserconfigprofile)\<`P`\>, `"clientSecret"`\> & \{ `clientSecret`: `string`; } |
