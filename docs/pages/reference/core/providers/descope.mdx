...
| Parameter | Type |
| :------ | :------ |
| `config` | [`OIDCUserConfig`](../providers.mdx#oidcuserconfigprofile)\<[`DescopeProfile`](descope.mdx#descopeprofile)\> |

### Returns

[`OIDCConfig`](../providers.mdx#oidcconfigprofile)\<[`DescopeProfile`](descope.mdx#descopeprofile)\>
