...
| Parameter | Type |
| :------ | :------ |
| `options` | [`OAuthUserConfig`](../providers.mdx#oauthuserconfigprofile)\<[`YandexProfile`](yandex.mdx#yandexprofile)\> |

### Returns

[`OAuthConfig`](../providers.mdx#oauthconfigprofile)\<[`YandexProfile`](yandex.mdx#yandexprofile)\>
