...
| Parameter | Type |
| :------ | :------ |
| `config` | [`OIDCUserConfig`](../providers.mdx#oidcuserconfigprofile)\<[`TwitchProfile`](twitch.mdx#twitchprofile)\> |

### Returns

[`OIDCConfig`](../providers.mdx#oidcconfigprofile)\<[`TwitchProfile`](twitch.mdx#twitchprofile)\>
