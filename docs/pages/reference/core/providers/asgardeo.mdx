...
| Parameter | Type |
| :------ | :------ |
| `config` | [`OIDCUserConfig`](../providers.mdx#oidcuserconfigprofile)\<[`AsgardeoProfile`](asgardeo.mdx#asgardeoprofile)\> |

### Returns

[`OIDCConfig`](../providers.mdx#oidcconfigprofile)\<[`AsgardeoProfile`](asgardeo.mdx#asgardeoprofile)\>
