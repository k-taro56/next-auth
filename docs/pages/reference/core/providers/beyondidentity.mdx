...
| Parameter | Type |
| :------ | :------ |
| `config` | [`OIDCUserConfig`](../providers.mdx#oidcuserconfigprofile)\<[`BeyondIdentityProfile`](beyondidentity.mdx#beyondidentityprofile)\> |

### Returns

[`OIDCConfig`](../providers.mdx#oidcconfigprofile)\<[`BeyondIdentityProfile`](beyondidentity.mdx#beyondidentityprofile)\>
