...
| Parameter | Type |
| :------ | :------ |
| `config` | [`OAuthUserConfig`](../providers.mdx#oauthuserconfigprofile)\<[`PassageProfile`](passage.mdx#passageprofile)\> |

### Returns

[`OAuthConfig`](../providers.mdx#oauthconfigprofile)\<[`PassageProfile`](passage.mdx#passageprofile)\>
