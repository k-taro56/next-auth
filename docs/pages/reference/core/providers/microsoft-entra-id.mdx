...
| Type parameter |
| :------ |
| `P` extends [`MicrosoftEntraIDProfile`](microsoft-entra-id.mdx#microsoftentraidprofile) |
...
| Parameter | Type |
| :------ | :------ |
| `options` | [`MicrosoftEntraIDOptions`](microsoft-entra-id.mdx#microsoftentraidoptionsp)\<`P`\> |
