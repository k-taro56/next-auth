...
| Parameter | Type |
| :------ | :------ |
| `options` | [`OIDCUserConfig`](../providers.mdx#oidcuserconfigprofile)\<[`AzureADB2CProfile`](azure-ad-b2c.mdx#azureadb2cprofile)\> & \{ `primaryUserFlow`: `string`; `tenantId`: `string`; } |

### Returns

[`OIDCConfig`](../providers.mdx#oidcconfigprofile)\<[`AzureADB2CProfile`](azure-ad-b2c.mdx#azureadb2cprofile)\>
