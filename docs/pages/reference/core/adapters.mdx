...
The default is to use a cookie + [JWT](https://authjs.dev/concepts/session-strategies#jwt-session)
based session store (`strategy: "jwt"`),
but you can also use a database adapter to store the session in a database.

Before you continue, Auth.js has a list of [official database adapters](https://adapters.authjs.dev). If your database is listed there, you
...
<Callout type="warning">
  **Note** Although `@auth/core` _is_ framework/runtime agnostic, an adapter might rely on a client/ORM package,
...
Each adapter method and its function signature is documented in the [Adapter](adapters.mdx#adapter) interface.
...
Auth.js _currently_ does not support [`access_token` rotation](https://authjs.dev/concepts/oauth) out of the box.
...
[`Awaitable`](types.mdx#awaitablet)\<[`AdapterAuthenticator`](adapters.mdx#adapterauthenticator)\>
...
[`Awaitable`](types.mdx#awaitablet)\<[`AdapterSession`](adapters.mdx#adaptersession)\>
...
[`Awaitable`](types.mdx#awaitablet)\<[`AdapterUser`](adapters.mdx#adapteruser)\>
...
[`Awaitable`](types.mdx#awaitablet)\<`undefined` \| `null` \| [`VerificationToken`](adapters.mdx#verificationtoken)\>
...
[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`void`\> \| [`Awaitable`](types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterSession`](adapters.mdx#adaptersession)\>
...
[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`void`\> \| [`Awaitable`](types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterUser`](adapters.mdx#adapteruser)\>
...
[`Awaitable`](types.mdx#awaitablet)\<`null` \| [`AdapterAccount`](adapters.mdx#adapteraccount)\>
...
[`Awaitable`](types.mdx#awaitablet)\<`null` \| [`AdapterAuthenticator`](adapters.mdx#adapterauthenticator)\>
...
[`Awaitable`](types.mdx#awaitablet)\<`null` \| \{
...
[`Awaitable`](types.mdx#awaitablet)\<`null` \| [`AdapterUser`](adapters.mdx#adapteruser)\>
...
[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`void`\> \| [`Awaitable`](types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterAccount`](adapters.mdx#adapteraccount)\>
...
[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`void`\> \| [`Awaitable`](types.mdx#awaitablet)\<`undefined` \| [`AdapterAccount`](adapters.mdx#adapteraccount)\>
...
[`Awaitable`](types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterSession`](adapters.mdx#adaptersession)\>
...
[`Awaitable`](types.mdx#awaitablet)\<`null` \| [`VerificationToken`](adapters.mdx#verificationtoken)\>
...
[`Account`](types.mdx#account).[`access_token`](types.mdx#access_token)
...
[`Account`](types.mdx#account).[`authorization_details`](types.mdx#authorization_details)
...
[`Account`](types.mdx#account).[`expires_at`](types.mdx#expires_at)
...
[`Account`](types.mdx#account).[`expires_in`](types.mdx#expires_in)
...
[`Account`](types.mdx#account).[`id_token`](types.mdx#id_token)
...
[`Account`](types.mdx#account).[`provider`](types.mdx#provider)
...
[`Account`](types.mdx#account).[`providerAccountId`](types.mdx#provideraccountid)
...
[`Account`](types.mdx#account).[`refresh_token`](types.mdx#refresh_token)
...
[`Account`](types.mdx#account).[`scope`](types.mdx#scope)
...
[`Account`](types.mdx#account).[`token_type`](types.mdx#token_type)
...
[`Account`](types.mdx#account).[`type`](types.mdx#type)
...
[`Account`](types.mdx#account).[`userId`](types.mdx#userid)
...
- [`Authenticator`](types.mdx#authenticator)
...
[`Authenticator`](types.mdx#authenticator).[`counter`](types.mdx#counter)
...
[`Authenticator`](types.mdx#authenticator).[`credentialBackedUp`](types.mdx#credentialbackedup)
...
[`Authenticator`](types.mdx#authenticator).[`credentialDeviceType`](types.mdx#credentialdevicetype)
...
[`Authenticator`](types.mdx#authenticator).[`credentialID`](types.mdx#credentialid)
...
[`Authenticator`](types.mdx#authenticator).[`credentialPublicKey`](types.mdx#credentialpublickey)
...
[`Authenticator`](types.mdx#authenticator).[`providerAccountId`](types.mdx#provideraccountid-1)
...
[`Authenticator`](types.mdx#authenticator).[`transports`](types.mdx#transports)
...
[`Authenticator`](types.mdx#authenticator).[`userId`](types.mdx#userid-1)
...
[`User`](types.mdx#user-2).[`email`](types.mdx#email-1)
...
[`User`](types.mdx#user-2).[`id`](types.mdx#id-2)
...
[`User`](types.mdx#user-2).[`image`](types.mdx#image)
...
[`User`](types.mdx#user-2).[`name`](types.mdx#name-3)
