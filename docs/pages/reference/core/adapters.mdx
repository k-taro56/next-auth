...
`Promise`\<`void`\> \| [`Awaitable`](types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterSession`](adapters.mdx#adaptersession)\>
...
`Promise`\<`void`\> \| [`Awaitable`](types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterUser`](adapters.mdx#adapteruser)\>
...
| Parameter | Type |
| :------ | :------ |
| `providerAccountId` | `Pick`\<[`AdapterAccount`](adapters.mdx#adapteraccount), `"provider"` \| `"providerAccountId"`\> |
...
`Promise`\<`void`\> \| [`Awaitable`](types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterAccount`](adapters.mdx#adapteraccount)\>
...
`Promise`\<`void`\> \| [`Awaitable`](types.mdx#awaitablet)\<`undefined` \| [`AdapterAccount`](adapters.mdx#adapteraccount)\>
...
| Parameter | Type |
| :------ | :------ |
| `session` | `Partial`\<[`AdapterSession`](adapters.mdx#adaptersession)\> & `Pick`\<[`AdapterSession`](adapters.mdx#adaptersession), `"sessionToken"`\> |
...
| Parameter | Type |
| :------ | :------ |
| `user` | `Partial`\<[`AdapterUser`](adapters.mdx#adapteruser)\> & `Pick`\<[`AdapterUser`](adapters.mdx#adapteruser), `"id"`\> |
