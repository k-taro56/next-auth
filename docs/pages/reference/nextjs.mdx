...
- [`Omit`](https://www.typescriptlang.org/docs/handbook/utility-types.html#omittype-keys)\<[`AuthConfig`](core.mdx#authconfig), `"raw"`\>
...
[`Awaitable`](core/types.mdx#awaitablet)\<`undefined` \| `boolean` \| [`Response`]( https://developer.mozilla.org/docs/Web/API/Response ) \| `NextResponse`\<`unknown`\>\>
...
| Parameter | Type |
| :------ | :------ |
| `data` | [`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`Session`](nextjs.mdx#session-2) \| \{ `user`: [`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<`undefined` \| [`User`](nextjs.mdx#user-2)\>; }\> |

##### Returns

[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`null` \| [`Session`](nextjs.mdx#session-2)\>
