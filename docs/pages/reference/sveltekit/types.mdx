...
| :------ | :------ | :------ |
| `params` | `Object` | - |
| `params.account` | `null` \| [`Account`](../sveltekit.mdx#account) | Contains information about the provider that was used to sign in.<br />Also includes TokenSet<br /><br />**Note**<br />available when `trigger` is `"signIn"` or `"signUp"` |
| `params.isNewUser`? | `boolean` | **Deprecated**<br />use `trigger === "signUp"` instead |
| `params.profile`? | [`Profile`](../sveltekit.mdx#profile) | The OAuth profile returned from your provider.<br />(In case of OIDC it will be the decoded ID Token or /userinfo response)<br /><br />**Note**<br />available when `trigger` is `"signIn"`. |
...
| Parameter | Type |
| :------ | :------ |
| `params` | \{ `session`: \{ `user`: [`AdapterUser`](adapter.mdx#adapteruser); } & [`AdapterSession`](adapter.mdx#adaptersession); `user`: [`AdapterUser`](adapter.mdx#adapteruser); } & \{ `session`: [`Session`](../sveltekit.mdx#session); `token`: [`JWT`](../next-auth/jwt.mdx#jwt); } & \{ `newSession`: `any`; `trigger`: `"update"`; } |

###### Returns

[`Awaitable`](../core/types.mdx#awaitablet)\<[`Session`](../sveltekit.mdx#session) \| [`DefaultSession`](../sveltekit.mdx#defaultsession)\>
...
| :------ | :------ | :------ |
| `params` | `Object` | - |
| `params.account` | `null` \| [`Account`](../sveltekit.mdx#account) | - |
...
| `params.profile`? | [`Profile`](../sveltekit.mdx#profile) | If OAuth provider is used, it contains the full<br />OAuth profile returned by your provider. |
| `params.user` | [`User`](../sveltekit.mdx#user-2) \| [`AdapterUser`](adapter.mdx#adapteruser) | - |
...
| :------ | :------ |
| `message` | `Object` |
| `message.user` | [`User`](../sveltekit.mdx#user-2) |
...
| :------ | :------ |
| `message` | `Object` |
| `message.account` | [`Account`](../sveltekit.mdx#account) |
| `message.profile` | [`User`](../sveltekit.mdx#user-2) \| [`AdapterUser`](adapter.mdx#adapteruser) |
| `message.user` | [`User`](../sveltekit.mdx#user-2) \| [`AdapterUser`](adapter.mdx#adapteruser) |
...
| :------ | :------ |
| `message` | `Object` |
| `message.session` | [`Session`](../sveltekit.mdx#session) |
...
| :------ | :------ |
| `message` | `Object` |
| `message.account` | `null` \| [`Account`](../sveltekit.mdx#account) |
| `message.isNewUser`? | `boolean` |
| `message.profile`? | [`Profile`](../sveltekit.mdx#profile) |
| `message.user` | [`User`](../sveltekit.mdx#user-2) |
...
| Parameter | Type |
| :------ | :------ |
| `message` | \{ `session`: `undefined` \| `null` \| `void` \| [`AdapterSession`](adapter.mdx#adaptersession); } \| \{ `token`: `null` \| [`JWT`](../next-auth/jwt.mdx#jwt); } |
