...
| Parameter | Type |
| :------ | :------ |
| `authenticator` | [`AdapterAuthenticator`](adapter.mdx#adapterauthenticator) |

##### Returns

[`Awaitable`](../core/types.mdx#awaitablet)\<[`AdapterAuthenticator`](adapter.mdx#adapterauthenticator)\>
...
[`Awaitable`](../core/types.mdx#awaitablet)\<[`AdapterSession`](adapter.mdx#adaptersession)\>
...
| Parameter | Type |
| :------ | :------ |
| `user` | [`AdapterUser`](adapter.mdx#adapteruser) |

##### Returns

[`Awaitable`](../core/types.mdx#awaitablet)\<[`AdapterUser`](adapter.mdx#adapteruser)\>
...
| Parameter | Type |
| :------ | :------ |
| `verificationToken` | [`VerificationToken`](adapter.mdx#verificationtoken) |

##### Returns

[`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`VerificationToken`](adapter.mdx#verificationtoken)\>
...
[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterSession`](adapter.mdx#adaptersession)\>
...
[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterUser`](adapter.mdx#adapteruser)\>
...
[`Awaitable`](../core/types.mdx#awaitablet)\<`null` \| [`AdapterAccount`](adapter.mdx#adapteraccount)\>
...
[`Awaitable`](../core/types.mdx#awaitablet)\<`null` \| [`AdapterAuthenticator`](adapter.mdx#adapterauthenticator)\>
...
[`Awaitable`](../core/types.mdx#awaitablet)\<`null` \| \{
  `session`: [`AdapterSession`](adapter.mdx#adaptersession);
  `user`: [`AdapterUser`](adapter.mdx#adapteruser);
  }\>
...
[`Awaitable`](../core/types.mdx#awaitablet)\<`null` \| [`AdapterUser`](adapter.mdx#adapteruser)\>
...
| Parameter | Type |
| :------ | :------ |
| `providerAccountId` | [`Pick`](https://www.typescriptlang.org/docs/handbook/utility-types.html#picktype-keys)\<[`AdapterAccount`](adapter.mdx#adapteraccount), `"provider"` \| `"providerAccountId"`\> |
...
| Parameter | Type |
| :------ | :------ |
| `account` | [`AdapterAccount`](adapter.mdx#adapteraccount) |

##### Returns

[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterAccount`](adapter.mdx#adapteraccount)\>
...
[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| [`AdapterAccount`](adapter.mdx#adapteraccount)\>
...
| Parameter | Type |
| :------ | :------ |
| `session` | [`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`AdapterSession`](adapter.mdx#adaptersession)\> & [`Pick`](https://www.typescriptlang.org/docs/handbook/utility-types.html#picktype-keys)\<[`AdapterSession`](adapter.mdx#adaptersession), `"sessionToken"`\> |

##### Returns

[`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterSession`](adapter.mdx#adaptersession)\>
...
| Parameter | Type |
| :------ | :------ |
| `user` | [`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<[`AdapterUser`](adapter.mdx#adapteruser)\> & [`Pick`](https://www.typescriptlang.org/docs/handbook/utility-types.html#picktype-keys)\<[`AdapterUser`](adapter.mdx#adapteruser), `"id"`\> |
...
[`Awaitable`](../core/types.mdx#awaitablet)\<`null` \| [`VerificationToken`](adapter.mdx#verificationtoken)\>
...
[`Account`](../sveltekit.mdx#account).[`access_token`](../sveltekit.mdx#access_token)
...
[`Account`](../sveltekit.mdx#account).[`authorization_details`](../sveltekit.mdx#authorization_details)
...
[`Account`](../sveltekit.mdx#account).[`expires_at`](../sveltekit.mdx#expires_at)
...
[`Account`](../sveltekit.mdx#account).[`expires_in`](../sveltekit.mdx#expires_in)
...
[`Account`](../sveltekit.mdx#account).[`id_token`](../sveltekit.mdx#id_token)
...
[`Account`](../sveltekit.mdx#account).[`provider`](../sveltekit.mdx#provider)
...
[`Account`](../sveltekit.mdx#account).[`providerAccountId`](../sveltekit.mdx#provideraccountid)
...
[`Account`](../sveltekit.mdx#account).[`refresh_token`](../sveltekit.mdx#refresh_token)
...
[`Account`](../sveltekit.mdx#account).[`scope`](../sveltekit.mdx#scope)
...
[`Account`](../sveltekit.mdx#account).[`token_type`](../sveltekit.mdx#token_type)
...
[`Account`](../sveltekit.mdx#account).[`type`](../sveltekit.mdx#type-3)
...
[`Account`](../sveltekit.mdx#account).[`userId`](../sveltekit.mdx#userid)
...
[`User`](../sveltekit.mdx#user-2).[`email`](../sveltekit.mdx#email-1)
...
[`User`](../sveltekit.mdx#user-2).[`id`](../sveltekit.mdx#id-1)
...
[`User`](../sveltekit.mdx#user-2).[`image`](../sveltekit.mdx#image)
...
[`User`](../sveltekit.mdx#user-2).[`name`](../sveltekit.mdx#name-3)
