...
`Promise`\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterSession`](adapter.mdx#adaptersession)\>
...
`Promise`\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterUser`](adapter.mdx#adapteruser)\>
...
| Parameter | Type |
| :------ | :------ |
| `providerAccountId` | `Pick`\<[`AdapterAccount`](adapter.mdx#adapteraccount), `"provider"` \| `"providerAccountId"`\> |
...
`Promise`\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| `null` \| [`AdapterAccount`](adapter.mdx#adapteraccount)\>
...
`Promise`\<`void`\> \| [`Awaitable`](../core/types.mdx#awaitablet)\<`undefined` \| [`AdapterAccount`](adapter.mdx#adapteraccount)\>
...
| Parameter | Type |
| :------ | :------ |
| `session` | `Partial`\<[`AdapterSession`](adapter.mdx#adaptersession)\> & `Pick`\<[`AdapterSession`](adapter.mdx#adaptersession), `"sessionToken"`\> |
...
| Parameter | Type |
| :------ | :------ |
| `user` | `Partial`\<[`AdapterUser`](adapter.mdx#adapteruser)\> & `Pick`\<[`AdapterUser`](adapter.mdx#adapteruser), `"id"`\> |
